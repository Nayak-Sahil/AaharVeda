        ...
        <header className="mb-2 px-4 shadow">
            <div className="relative mx-auto flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
                <a className="relative -top-1 flex items-center text-2xl font-black" href="/">
                    <img src={AaharVedaVerti} alt="AaharVeda" width={150} />
                ...
                <nav aria-label="Header Navigation" className="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
                    <ul className="flex flex-col items-start sm:items-center gap-y-4 sm:flex-row sm:gap-x-8">
                        <li className=""><a className="text-gray-800 hover:text-primary" href="#">Home</a></li>
                        <li className=""><a className="text-gray-800 hover:text-primary" href="#">Features</a></li>
                        <li className=""><a className="text-gray-800 hover:text-primary" href="#">How it works?</a></li>
